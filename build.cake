...
BuildSettings.Packages.AddRange(new PackageDefinition[] {
    ...
    NUnitConsoleRunnerNuGetPackage = new NuGetPackage(
        ...
        checks: new PackageCheck[] {
            ...
            HasDirectory("tools").WithFiles(
                "nunit-console.exe", "nunit-console.exe.config", "nunit.common.dll",
            ...
            HasDirectory("tools/agents/net462").WithFiles(
                "nunit-agent-net462.exe", "nunit-agent-net462.exe.config", "nunit-agent-net462-x86.exe", "nunit-agent-net462-x86.exe.config",
                 "nunit.common.dll", "nunit.engine.core.dll", "nunit.engine.api.dll", "testcentric.metadata.dll"),
        ...
        symbols: new PackageCheck[] {
            HasDirectory("tools").WithFiles(
                "nunit.engine.pdb",  "nunit.common.pdb", "nunit.engine.core.pdb", "nunit.engine.api.pdb", "nunit-console.pdb"),
            HasDirectory("tools/agents/net462").WithFiles(
                "nunit-agent.pdb", "nunit-agent-x86.pdb", "nunit.common.pdb", "nunit.engine.core.pdb", "nunit.engine.api.pdb"),
            HasDirectory("tools/agents/netcoreapp3.1").WithFiles(
                "nunit-agent.pdb", "nunit.engine.core.pdb", "nunit.common.pdb", "nunit.engine.api.pdb"),
            HasDirectory("tools/agents/net6.0").WithFiles(
                "nunit-agent.pdb", "nunit.common.pdb", "nunit.engine.core.pdb", "nunit.engine.api.pdb"),
            HasDirectory("tools/agents/net7.0").WithFiles(
                "nunit-agent.pdb", "nunit.common.pdb", "nunit.engine.core.pdb", "nunit.engine.api.pdb"),
            HasDirectory("tools/agents/net8.0").WithFiles(
                "nunit-agent.pdb", "nunit.common.pdb", "nunit.engine.core.pdb", "nunit.engine.api.pdb")
    ...
    NUnitConsoleRunnerNetCorePackage = new DotNetToolPackage(
        ...
        checks: new PackageCheck[]
        {
            ...
            HasDirectory(".store/nunit.consolerunner.netcore/**/tools/net8.0/any").WithFiles(
                ...
                "nunit.engine.dll", "nunit.common.dll", "nunit.engine.core.dll", "nunit.engine.api.dll", "testcentric.metadata.dll",
    ...
    NUnitConsoleRunnerChocolateyPackage = new ChocolateyPackage(
        ...
        checks: new PackageCheck[] {
            ...
            HasDirectory("tools/agents/net462").WithFiles(
                "nunit-agent-net462.exe", "nunit-agent-net462.exe.config", "nunit-agent-net462-x86.exe", "nunit-agent-net462-x86.exe.config",
                "nunit.engine.core.dll", "nunit.engine.api.dll", "nunit.common.dll", "testcentric.metadata.dll"),
            HasDirectory("tools/agents/netcoreapp3.1").WithFiles(
                "nunit-agent-netcore31.dll", "nunit-agent-netcore31.dll.config",
                "nunit.engine.core.dll", "nunit.engine.api.dll", "nunit.common.dll", "testcentric.metadata.dll"),
            HasDirectory("tools/agents/net6.0").WithFiles(
    ...
    NUnitEnginePackage = new NuGetPackage(
        ...
        checks: new PackageCheck[] {
            ...
            HasDirectory("lib/net462").WithFiles(
                "nunit.engine.dll", "nunit.engine.core.dll", "nunit.engine.api.dll", "nunit.common.dll", "testcentric.metadata.dll"),
            HasDirectory("lib/net8.0").WithFiles(
                "nunit.engine.dll", "nunit.engine.core.dll", "nunit.engine.api.dll", "nunit.common.dll", "testcentric.metadata.dll", "Microsoft.Extensions.DependencyModel.dll"),
