        ...
        ChocolateyPack("choco/nunit-console-runner.nuspec",
            new ChocolateyPackSettings()
            {
                ...
                Files = new [] {
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net20/nunit-agent.pdb", Target="tools/agents/net20" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net20/nunit-agent-x86.pdb", Target="tools/agents/net20" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net20/nunit.engine.api.pdb", Target="tools/agents/net20" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net20/nunit.engine.core.pdb", Target="tools/agents/net20" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net40/nunit-agent.pdb", Target="tools/agents/net40" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net40/nunit-agent-x86.pdb", Target="tools/agents/net40" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net40/nunit.engine.api.pdb", Target="tools/agents/net40" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/net40/nunit.engine.core.pdb", Target="tools/agents/net40" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/netcoreapp3.1/nunit-agent.pdb", Target="tools/agents/netcoreapp3.1" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/netcoreapp3.1/nunit.engine.api.pdb", Target="tools/agents/netcoreapp3.1" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_DIR + "bin/agents/netcoreapp3.1/nunit.engine.core.pdb", Target="tools/agents/netcoreapp3.1" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_NET20_BIN_DIR + "nunit3-console.pdb", Target="tools" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_NET20_BIN_DIR + "nunit.engine.api.pdb", Target="tools" },
                    ...
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_NET20_BIN_DIR + "nunit.engine.core.pdb", Target="tools" },
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_NET20_BIN_DIR + "nunit.engine.dll", Target="tools" },
                    new ChocolateyNuSpecContent { Source = CURRENT_IMG_NET20_BIN_DIR + "nunit.engine.pdb", Target="tools" },
