...
namespace NUnit.Engine.Services
{
    public class AgentProcessTests
    {
        ...
        [TestCase("net-4.8", false, "../agents/net462/nunit-agent.exe")]
        [TestCase("net-4.8", true, "../agents/net462/nunit-agent-x86.exe")]
        [TestCase("net-4.6.2", false, "../agents/net462/nunit-agent.exe")]
        [TestCase("net-4.6.2", true, "../agents/net462/nunit-agent-x86.exe")]
