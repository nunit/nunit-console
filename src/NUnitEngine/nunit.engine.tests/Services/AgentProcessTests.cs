...
namespace NUnit.Engine.Services
{
    public class AgentProcessTests
    {
        ...
        [TestCase("net-4.5", false, "../agents/net462/nunit-agent.exe")]
        [TestCase("net-4.5", true, "../agents/net462/nunit-agent-x86.exe")]
        [TestCase("net-4.0", false, "../agents/net462/nunit-agent.exe")]
        [TestCase("net-4.0", true, "../agents/net462/nunit-agent-x86.exe")]
        [TestCase("net-3.5", false, "../agents/net462/nunit-agent.exe")]
        [TestCase("net-3.5", true, "../agents/net462/nunit-agent-x86.exe")]
        [TestCase("net-2.0", false, "../agents/net462/nunit-agent.exe")]
        [TestCase("net-2.0", true, "../agents/net462/nunit-agent-x86.exe")]
