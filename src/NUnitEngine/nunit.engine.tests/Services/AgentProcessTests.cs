...
namespace NUnit.Engine.Services
{
    public class AgentProcessTests
    {
        ...
        [TestCase("netcore-2.1", false, "net6.0/nunit-agent-net60.dll")]
        [TestCase("netcore-2.1", true, "net6.0/nunit-agent-net60.dll")]
        [TestCase("netcore-3.1", false, "net6.0/nunit-agent-net60.dll")]
        [TestCase("netcore-3.1", true, "net6.0/nunit-agent-net60.dll")]
