...
namespace NUnit
{
    ...
    public static class EnginePackageSettings
    {
        ...
        /// </summary>
        public const string ActiveConfig = "ActiveConfig"; // TYPE: string
        ...
        /// </summary>
        public const string AutoBinPath = "AutoBinPath"; // TYPE: bool
        ...
        /// </summary>
        public const string BasePath = "BasePath"; // TYPE: string

        /// <summary>
        /// Path to the config file to use in running the tests.
        /// </summary>
        public const string ConfigurationFile = "ConfigurationFile"; // TYPE: string

        /// <summary>
        /// Flag (bool) indicating whether tests are being debugged.
        /// </summary>
        public const string DebugTests = "DebugTests"; // TYPE: bool

        /// <summary>
        /// Bool flag indicating whether a debugger should be launched at agent
        /// startup. Used only for debugging NUnit itself.
        /// </summary>
        public const string DebugAgent = "DebugAgent"; // TYPE: bool
        ...
        /// </summary>
        public const string PrivateBinPath = "PrivateBinPath"; // TYPE: string
        ...
        /// </summary>
        public const string MaxAgents = "MaxAgents"; // TYPE: int
        ...
        /// </summary>
        public const string RequestedRuntimeFramework = "RequestedRuntimeFramework"; // TYPE: string
        ...
        /// use the target framework for which an assembly was built.
        /// </summary>
        public const string RequestedFrameworkName = "RequestedFrameworkName"; // TYPE: string

        /// <summary>
        /// Indicates the Target runtime selected for use by the engine,
        /// based on the requested runtime and assembly metadata.
        /// </summary>
        public const string TargetFrameworkName = "TargetFrameworkName"; // TYPE: string

        /// <summary>
        /// Indicates the name of the agent requested by the user.
        /// </summary>
        public const string RequestedAgentName = "RequestedAgentName"; // TYPE: string

        /// <summary>
        /// Indicates the name of the agent that was actually used.
        /// </summary>
        public const string SelectedAgentName = "SelectedAgentName"; // TYPE: string
        ...
        /// </summary>
        public const string InternalTraceLevel = "InternalTraceLevel"; // TYPE: string
        ...
        /// </summary>
        public const string PrincipalPolicy = "PrincipalPolicy"; // TYPE: string
        ...
        /// </summary>
        public const string WorkDirectory = "WorkDirectory"; // TYPE: string
        ...
        /// </summary>
        public const string ImageRuntimeVersion = "ImageRuntimeVersion"; // TYPE: string

        /// <summary>
        /// True if any assembly in the package requires running as a 32-bit
        /// process when on a 64-bit system.
        /// </summary>
        public const string ImageRequiresX86 = "ImageRequiresX86"; // TYPE: bool
        ...
        /// </summary>
        public const string ImageRequiresDefaultAppDomainAssemblyResolver = "ImageRequiresDefaultAppDomainAssemblyResolver"; // TYPE: bool

        /// <summary>
        /// The FrameworkName specified on a TargetFrameworkAttribute for the assembly
        /// </summary>
        public const string ImageTargetFrameworkName = "ImageTargetFrameworkName"; // TYPE: string
