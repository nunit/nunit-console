...
namespace NUnit.Engine.Internal
{
    ...
    {
        static readonly Logger log = InternalTrace.GetLogger(typeof(ExtensionAssemblyTracker));
        ...
        public void AddOrUpdate(ExtensionAssembly candidateAssembly)
        {
            ...
            if (_byName.TryGetValue(assemblyName, out ExtensionAssembly existing))
            {
            ...
            {
                _byName[assemblyName] = candidateAssembly;
                log.Debug($"Asembly added: {assemblyName}");
            }
        }
    }
}
