...
static string NETFX_CONSOLE_DIR; NETFX_CONSOLE_DIR = PROJECT_DIR + "src/NUnitConsole/nunit3-console/";
static string NETFX_CONSOLE_PROJECT; NETFX_CONSOLE_PROJECT = NETFX_CONSOLE_DIR + "nunit3-console.csproj";
static string NETCORE_CONSOLE_DIR; NETCORE_CONSOLE_DIR = PROJECT_DIR + "src/NUnitConsole/nunit3-netcore-console/";
static string NETCORE_CONSOLE_PROJECT; NETCORE_CONSOLE_PROJECT = NETCORE_CONSOLE_DIR + "nunit3-netcore-console.csproj";
